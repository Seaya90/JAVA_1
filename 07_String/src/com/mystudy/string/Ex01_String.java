...
public class Ex01_String { 
	...
	public static void main(String[] args) {
		...
		//String str = "홍길동"; //기본 데이타 타입처럼 사용
		//String str = new String("홍길동"); //객체생성 사용
		String str1 = "Java";
		String str2 = "World";
		...
		System.out.println("str1.equals(strObj1): " 
				+ str1.equals(strObj1));
		System.out.println("str11.equals(strObj1): " 
				+ str11.equals(strObj1));
		...
		//char[] ch2 = {d.charAt(0), d.charAt(1), d.charAt(0)};
		char[] ch2 = new char[4];
		...
		System.out.println(str3.startsWith("abd")); //시작 문자열 여부 확인
