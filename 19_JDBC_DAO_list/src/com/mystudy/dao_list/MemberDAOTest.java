...
//		System.out.println("입력건수: " + cnt);
		...
		System.out.println("--- insertListCommitOneByOne() 중간에 key중복 ---"); 
		list.clear();
		list.add(new MemberVO("99991", "pw", "김유신6", "010-2222-1111", "서울"));
		list.add(new MemberVO("7777", "pw", "김유신7", "010-3333-1111", "서울"));
		list.add(new MemberVO("99992", "pw", "김유신3", "010-3333-1111", "서울"));
		list.add(new MemberVO("8888", "pw", "김유신7", "010-3333-1111", "서울"));
		list.add(new MemberVO("99993", "pw", "김유신3", "010-3333-1111", "서울"));
		StringBuilder sb = dao.insertListCommitOneByOne(list);
